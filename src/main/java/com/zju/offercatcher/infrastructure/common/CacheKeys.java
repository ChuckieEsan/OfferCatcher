...
public final class CacheKeys {
    ...
    public static String statsOverview() {
        return PREFIX + ":stats:overview";
    }

    public static String statsClusters() {
        return PREFIX + ":stats:clusters";
    }

    public static String statsCompanies() {
        return PREFIX + ":stats:companies";
    }
    ...
    public static String statsPositions() {
        return PREFIX + ":stats:positions";
    }

    public static String statsEntitiesPattern() {
        return PREFIX + ":stats:entities:*";
    }
    ...
    public static String questionsListPattern() {
        return PREFIX + ":questions:list:*";
    }

    public static String questionsCountPattern() {
        return PREFIX + ":questions:count:*";
    }
    ...
    public static String toolSearchPattern() {
        return PREFIX + ":tool:search:*";
    }

    public static String toolGraphPattern() {
        return PREFIX + ":tool:graph:*";
    }

    public static String toolWebPattern() {
        return PREFIX + ":tool:web:*";
    }
